...
$template2 = $app->getTemplate();
$doc = JFactory::getDocument();
$doc->addScript('templates/'.$template2.'/js/progress.min.js');
?>
<!-- BEGIN: GENERAL STATS -->
...
<div class="kblock kgenstats">
	<div class="kheader">
		...
		<div><span><?php echo $this->escape($this->config->board_title); ?> <?php echo JText::_('COM_KUNENA_STAT_FORUMSTATS'); ?></span></div>
	</div>
...
<div class="kblock kpopsubjstats">
	<div class="kheader">
		...
		<div><span><?php echo $top[0]->title ?></span></div>
	</div>
			...
			<table class="kblocktable">
				<tbody>
					...
					<tr class="k<?php echo $this->escape($tabclass[$id & 1]); ?>">
						...
						<td class="kcol-mid">
							<div class="progress-bar progress-bar-horizontal progress-bar-default" data-value="<?php echo $item->percent ?>" data-stroke="5" data-trail="5">
	    					</div>
						</td>
						<td class="kcol-last">
							<?php echo $item->count ?>
