 ...
 * @since       11.1
 */
if(!class_exists('JHtmlJPROBehavior')) {
	...
	define('JPRO_BEHAVIOR_URL', $path);
	
	abstract class JHtmlJPROBehavior
	{
		/**
		...
		public static function jquery25($noConflict = true, $debug = null)
		{
			...
			JHtml::_('script', JPRO_BEHAVIOR_URL.'jquery/jquery.min.js');
	
			// Check if we are loading in noConflict
			if ($noConflict)
			{
				JHtml::_('script', JPRO_BEHAVIOR_URL.'jquery/jquery-noconflict.js');
			}
		...
		public static function jqueryui25(array $components = array('core'), $debug = null)
		{
			...
			foreach ($components as $component)
			{
				...
				{
					JHtml::_('script', JPRO_BEHAVIOR_URL.'jquery/jquery.ui.' . $component . '.min.js');
		...
		public static function jquerychosen25($selector = '.advandedSelect', $debug = nulll)
		{
			...
			JHtml::_('script', JPRO_BEHAVIOR_URL.'jquery/chosen/jquery.actual.min.js');
			JHtml::_('script', JPRO_BEHAVIOR_URL.'jquery/chosen/chosen.jquery.js');
			JHtml::_('stylesheet', JPRO_BEHAVIOR_URL.'jquery/chosen/chosen.css');
		...
		public static function jqueryeasing($debug = null)
		{
			...
			JHtml::_('script', JPRO_BEHAVIOR_URL.'jquery/jquery.easing.1.3.js');
