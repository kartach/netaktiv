...
var JPRODepend = window.JPRODepend || {};

JPRODepend.inst = new JPRODependForm();
window.addEvent('load', function() {
	setTimeout(JPRODepend.inst.start.bind(JPRODepend.inst), 100);
});