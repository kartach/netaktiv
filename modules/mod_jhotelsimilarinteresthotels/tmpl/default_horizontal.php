...
$items = (int)$params->get( 'number_of_properties' ) <=4 && (int)$params->get( 'number_of_properties' ) > 0 ? (int)$params->get( 'number_of_properties' ):4;

?>
<?php
if(isset($otherUsersProperties) && count($otherUsersProperties)>0) {
	?>
	<div id="similiar-hotels" class="owl-carousel similiar-hotels owl-theme section group property-section">
	<?php
    foreach ($otherUsersProperties as $otherUsersProperty) {
		    ?>
		    <div class="column_10_of_12 property-container">
			    ...
			    <div class="section group property-section">
					    <div class="col column_12_of_12">
						    <div class="property-image-horiz col column_4_of_12">
							    <?php
							    if ( ! empty( $otherUsersProperty->hotel_picture_path ) )
							    { ?>
								    <div class='picture-container-horiz'>
									    <a target="_blank"
			    ...
			    <div class="section group property-section prop-rating">
				    <div class="col column_12_of_12">
					    <div class="section group property-section prop-rating ">
						    <div class="col column_12_of_12" id="horizontal-rating">
					    ...
					    <div class="section group property-section prop-rating">
						    <div class="col column_12_of_12 block">
							    <?php if($otherUsersProperty->recommended==1){?>

								    <div class="hotel-recommanded" id="recommanded">
			    ...
			    <div class="section group property-section">
					    <div class="col column_12_of_12 prop-book">
	...
	<script>
		jQuery(document).ready(function() {
			var owl = jQuery('#similiar-hotels');
			owl.owlCarousel({
