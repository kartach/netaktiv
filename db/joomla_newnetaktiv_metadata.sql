...
ALTER TABLE `qk7ce_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=768;
ALTER TABLE `qk7ce_banners`
...
ALTER TABLE `qk7ce_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10170;
ALTER TABLE `qk7ce_finder_filters`
