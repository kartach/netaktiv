...
<figure class="item_img img-intro img-intro__<?php echo htmlspecialchars($params->get('intro_image_align')); ?>">
	...
	<div class="image_content">
		...
		<div>
			...
			if ($params->get('createdby') || $params->get('show_category') || $params->get('show_hits')) : ?>
			<!-- info TOP -->
			<div class="item_info">
...
<div class="item_content">
	...
	if ($params->get('published') || $params->get('createdby') || $params->get('show_category') || $params->get('show_hits')) : ?>
	<!-- info TOP -->
	<div class="item_info">
		<dl class="item_info_dl">
			<dt class="article-info-term"><?php /*echo JText::_('COM_CONTENT_ARTICLE_INFO');*/ ?></dt>
