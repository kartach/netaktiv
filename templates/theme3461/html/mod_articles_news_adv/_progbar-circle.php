...
<div class="item_content">
    ...
    <div  class="progress-bar progress-bar-radial progress-bar-default" data-value="<?php echo htmlspecialchars($item_images->image_intro_caption); ?>" data-stroke="10" data-trail="10"
