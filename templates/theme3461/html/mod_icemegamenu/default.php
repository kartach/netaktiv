<a href="#" class="sidebar-menu fa fa-align-justify"></a>
<?php
/**
...
<?php $doc->addScriptdeclaration('(function($){$(document).ready(function(){$(".home_menu .sidebar-menu").click(function(e){$(".home_menu .icemegamenu").toggleClass("active");$(this).toggleClass("fa-close");return false;})})})(jQuery);'); ?>