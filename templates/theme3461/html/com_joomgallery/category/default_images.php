...
<?php endif; ?>
<div class="jg_gallery row cols-<?php echo $this->_config->get('jg_colnumb'); ?>" id="jg_gallery">
<?php if($this->params->get('show_all_in_popup')):
      ...
      $index      = 0;
      $this->i    = 0;
      $item_width = 12 / $this->_config->get('jg_colnumb');
    ...
    <div class="jg_element_cat mix gallery-grid gallery-item col-sm-<?php echo $item_width;?>" data-date="<?php echo JHTML::_('date', $row->imgdate, 'YmdHis'); ?>" data-value="<?php echo $key; ?>"<?php 
...
<?php     endif; ?>
          <li class="jg_links">
            <a class="fancybox-thumb" data-title="<?php echo ($row->imgtitle); ?>" href="<?php echo $row->link; ?>"><i class="fa fa-search-plus"></i></a>
