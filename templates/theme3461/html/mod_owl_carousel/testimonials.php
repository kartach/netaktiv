...
?>
<div class="owl-carousel testimonials owl-carousel_<?php echo $module->id; ?> mod_owl_carousel mod_owl_carousel__<?php echo $moduleclass_sfx; ?>" id="module_<?php echo $module->id; ?>"
...
>
	...
	foreach ($list as $key => $item) : ?>
		<div id="item_<?php echo $item->id; ?>">
			<div class="owl-item_content"><?php require JModuleHelper::getLayoutPath('mod_owl_carousel', '_testimonials'); ?></div>
		</div>	
	<?php endforeach;	?>
</div>
<?php
