...
JHtml::script( JURI::root() . 'administrator' . DS . 'components' . DS . $this->app->input->get( 'option', 'com_arkeditor' ) . DS . 'js' . DS . 'toolbars.js' );
JHtml::script( JURI::root() . 'administrator' . DS . 'components' . DS . $this->app->input->get( 'option', 'com_arkeditor' ) . DS . 'js' . DS . 'groups.js' );
?>
