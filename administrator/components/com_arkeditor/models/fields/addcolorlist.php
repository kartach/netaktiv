...
class JFormFieldAddColorList extends JFormField
{
	protected $type = 'AddColorList';
	...
	protected function getInput()
	{
		...
		<tr>
			<td>Value<br/>
				<input class="color {hash:false,caps:true}" type="'.$id.'_inputvalue" id="input" name="'.$id.'_inputvalue" style="min-width:150px;"/>
			</td>
			<td valign="bottom">
