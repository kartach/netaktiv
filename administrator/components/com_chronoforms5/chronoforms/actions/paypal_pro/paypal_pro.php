...
Class PaypalPro extends \GCore\Admin\Extensions\Chronoforms\Action{
	...
	public static function config(){
		...
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][PAYMENTACTION]', array('type' => 'hidden', /*'label' => l_('CF_PAYPAL_PAYMENTACTION'), 'class' => 'M', 'sublabel' => l_('CF_PAYPAL_PAYMENTACTION_DESC')*/));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][CREDITCARDTYPE]', array('type' => 'text', 'label' => l_('CF_PAYPAL_CREDITCARDTYPE'), 'class' => 'L', 'sublabel' => l_('CF_PAYPAL_CREDITCARDTYPE_DESC')));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][ACCT]', array('type' => 'text', 'label' => l_('CF_PAYPAL_ACCT'), 'class' => 'M', 'sublabel' => l_('CF_PAYPAL_ACCT_DESC')));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][AMT]', array('type' => 'text', 'label' => l_('CF_PAYPAL_AMOUNT'), 'class' => 'M', 'sublabel' => l_('CF_PAYPAL_AMOUNT_DESC')));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][CURRENCYCODE]', array('type' => 'text', 'label' => l_('CF_PAYPALPRO_CURRENCY_CODE'), 'class' => 'M', 'sublabel' => l_('CF_PAYPALPRO_CURRENCY_CODE_DESC')));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][CVV2]', array('type' => 'text', 'label' => l_('CF_PAYPAL_CVV2'), 'class' => 'M', 'sublabel' => l_('CF_PAYPAL_CVV2_DESC')));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][FIRSTNAME]', array('type' => 'text', 'label' => l_('CF_PAYPAL_FNAME'), 'class' => 'M', 'sublabel' => l_('CF_PAYPAL_FNAME_DESC')));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][LASTNAME]', array('type' => 'text', 'label' => l_('CF_PAYPAL_LNAME'), 'class' => 'M', 'sublabel' => l_('CF_PAYPAL_LNAME_DESC')));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][STREET]', array('type' => 'text', 'label' => l_('CF_PAYPAL_ADD1'), 'class' => 'M', 'sublabel' => l_('CF_PAYPAL_ADD1_DESC')));
		...
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][COUNTRYCODE]', array('type' => 'text', 'label' => l_('CF_PAYPAL_COUNTRY'), 'class' => 'M', 'sublabel' => l_('CF_PAYPAL_COUNTRY_DESC')));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][EXPDATE_m]', array('type' => 'text', 'label' => l_('CF_PAYPAL_EXPDATE_m'), 'class' => 'M', 'sublabel' => l_('CF_PAYPAL_EXPDATE_m_DESC')));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][EXPDATE_y]', array('type' => 'text', 'label' => l_('CF_PAYPAL_EXPDATE_y'), 'class' => 'M', 'sublabel' => l_('CF_PAYPAL_EXPDATE_y_DESC')));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][API_USERNAME]', array('type' => 'text', 'label' => l_('CF_PAYPAL_API_USERNAME'), 'class' => 'M', 'sublabel' => l_('CF_PAYPAL_API_USERNAME_DESC')));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][API_PASSWORD]', array('type' => 'text', 'label' => l_('CF_PAYPAL_API_PASSWORD'), 'class' => 'M', 'sublabel' => l_('CF_PAYPAL_API_PASSWORD_DESC')));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][API_SIGNATURE]', array('type' => 'text', 'label' => l_('CF_PAYPAL_API_SIGNATURE'), 'class' => 'M', 'sublabel' => l_('CF_PAYPAL_API_SIGNATURE_DESC')));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][USE_PROXY]', array('type' => 'dropdown', 'label' => l_('CF_PAYPAL_USE_PROXY'), 'options' => array(0 => l_('NO'), 1 => l_('YES')), 'sublabel' => l_('CF_PAYPAL_USE_PROXY_DESC')));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][PROXY_HOST]', array('type' => 'text', 'label' => l_('CF_PAYPAL_PROXY_HOST'), 'class' => 'M', 'sublabel' => l_('CF_PAYPAL_PROXY_HOST_DESC')));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][PROXY_PORT]', array('type' => 'text', 'label' => l_('CF_PAYPAL_PROXY_PORT'), 'class' => 'M', 'sublabel' => l_('CF_PAYPAL_PROXY_PORT_DESC')));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][extra_params]', array('type' => 'textarea', 'label' => l_('CF_PAYPAL_EXTRA_PARAMS'), 'rows' => 5, 'cols' => 40, 'sublabel' => l_('CF_PAYPAL_EXTRA_PARAMS_DESC')));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][debugging]', array('type' => 'dropdown', 'label' => l_('CF_PAYPALPRO_DEBUG'), 'options' => array(0 => l_('NO'), 1 => l_('YES')), 'sublabel' => l_('CF_PAYPALPRO_DEBUG_DESC')));
