...
Class EventLoop extends \GCore\Admin\Extensions\Chronoforms\Action{
	...
	public static function config(){
		echo \GCore\Helpers\Html::formStart('action_config event_loop_action_config', 'event_loop_action_config__XNX_');
		echo \GCore\Helpers\Html::formSecStart();
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][_XNX_][event]', array('type' => 'text', 'label' => l_('CF_EVENTLOOP_EVENT'), 'value' => 'load', 'class' => 'M', 'sublabel' => l_('CF_EVENTLOOP_EVENT_DESC')));
