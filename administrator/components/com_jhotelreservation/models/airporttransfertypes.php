 ...
 */
class JHotelReservationModelAirportTransferTypes extends JModelList
{
    ...
    protected function getListQuery()
    {
        ...
        $query->from($db->quoteName('#__hotelreservation_airport_transfer_types').' AS ha');
        ...
        $query->group('ha.airport_transfer_type_id');
    ...
    protected function populateState($ordering = null , $direction = null) {
        ...
        $statusId = $app->getUserStateFromRequest($this->context.'.filter.airline_id', 'airport_transfer_type_id');
        ...
        parent::populateState('ha.airport_transfer_type_id', 'desc');
    }
}