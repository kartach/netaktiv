 ...
 *
 */
class JHotelReservationModelPaymentProcessor extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 * @since   1.6
	 */
	protected $text_prefix = 'COM_JHOTELRESEVATION_PAYMENT_PROCESSOR';
	 ...
	 * @var		string
	 */
	protected $_context		= 'com_jhotelreservation.paymentprocessor';
	...
	*/
	public function getTable($type = 'PaymentProcessor', $prefix = 'Table', $config = array())
	{
	...
	protected function populateState()
	{
		...
		if (!($hotelId = $app->getUserState('com_jhotelreservation.paymentprocessors.filter.hotel_id'))) {
			$hotelId = JRequest::getInt('hotel_id', '-1');
		}
		$this->setState('paymentprocessor.hotel_id', $hotelId);
	}
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_jhotelreservation.paymentprocessor', 'item', array('control' => 'jform', 'load_data' => $loadData), true);
		if (empty($form))
		{
			return false;
		}
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jhotelreservation.edit.paymentprocessor.data', array());
