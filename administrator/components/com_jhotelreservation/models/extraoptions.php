...
class JHotelReservationModelExtraOptions extends JModelList
{
	...
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				'id', 'eo.id',
				'title', 'eo.name',
				'ordering', 'eo.ordering',
                'price','eo.price',
                'start_date','eo.start_date',
                'end_date','eo.end_date',
                'is_per_day','eo.is_per_day',
                'mandatory','eo.mandatory',
                'status','eo.status'
			);
		}
	...
	protected function getListQuery()
	{
		...
		$newFromDefault = $this->getState('newFromDefault');
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$newFromDefault = JRequest::getVar('newFromDefault', null);
		$this->setState($this->context.'newFromDefault', $newFromDefault);
		$this->setState('newFromDefault', $newFromDefault);
	...
	function saveorder($pks, $order)
	{
		...
		$table		= JTable::getInstance('ExtraOptions');
		$user 		= JFactory::getUser();
		$conditions	= array();
