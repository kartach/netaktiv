...
class K2ElementK2Users extends K2Element
{
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		$document->addStyleSheet(JURI::root(true).'/media/k2/assets/css/select2.min.css?v=2.7.1');
		$document->addScript(JURI::root(true).'/media/k2/assets/js/select2.min.js?v=2.7.1');
