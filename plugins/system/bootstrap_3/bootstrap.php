...
abstract class JHtmlBootstrap
{
	...
	public static function framework($debug = null)
	{
		...
		JHtml::_('script','plugins/system/bootstrap_3/assets/js/bootstrap.min.js', false, false, false, false, $debug);
	...
	public static function startAccordion($selector = 'myAccordian', $params = array())
	{
		if (!isset(static::$loaded[__METHOD__][$selector]))
		{
			...
			return '<div id="' . $selector . '" class="panel-group" role="tablist" aria-multiselectable="true">';
		}
	}
	...
	public static function addSlide($selector, $text, $id, $class = '')
	{
		...
		$collapsed = (static::$loaded[__CLASS__ . '::startAccordion'][$selector]['active'] == $id) ? '' : ' class="collapsed"';
		...
		$html = '<div class="panel panel-default ' . $class . '">'
			...
			. '<a' . $collapsed . ' role="button" href="#collapse_' . $id . '" data-toggle="collapse"' . $parent . ' aria-expanded="true" aria-controls="collapse_' . $id . '">'
			. $text
			. '</a>'
			. '</div>'
